...
**Note:** NEVER install a Python application directly in your system `sudo pip install ...`.
You do not want to mess your startup script or any system python application.
